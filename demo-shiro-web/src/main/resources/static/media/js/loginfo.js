        ...
        init: function () {
            table=$('#sample_1').DataTable({
                ...
                "columns": [
                            ...
                            { "data": "logOperatorName","bSortable": false,"searchable":true},
                            { "data": "logOperatorTime","bSortable": false,"searchable":true },
                            { "data": "logOperatorType","bSortable": false,"searchable":false,
                            ...
                            { "data": "logOperatorContent","bSortable": false,"searchable":true},
                            { "data": "logOperatorContent","bSortable": false,"searchable":true,
                            	...
                            	render: function ( data, type, row ) {
    		            		    if(data.length<100){
    		            		    	...
    		            		    	return "<p class='showinfo' >点击查看详细信息</p>";	
    		            		    }
				...
				fnDrawCallback: function () {
					  ...
					  $(".showinfo").click(function(){
						 ...
						 var lo = data['logOperatorContent'];
						 layer.open({
							  type: 1,
							  title: "日志信息",
							  closeBtn: 0,
